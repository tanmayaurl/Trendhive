...
const stripePromise = loadStripe("pk_test_51Nw...your_key_here"); // Replace with your Stripe publishable key
...
function CheckoutForm({ product }: { product: any }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    // This is a mock. In a real app, you'd create a PaymentIntent on your server.
    setTimeout(() => {
      setSuccess(true);
      setLoading(false);
    }, 1500);
